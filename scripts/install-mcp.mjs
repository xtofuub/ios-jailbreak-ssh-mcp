...
Options:
  ...
  --enable-r2 <true|false>     Enable radare2 static analysis tools. Default: true
                                (radare2 itself must be installed on the iOS device via Sileo, or locally as a fallback)
